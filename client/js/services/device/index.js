...
module.exports = angular.module('uDomo.Device').factory(
  'DeviceFactory',
  [ '$http', ($http) => Object.assign({
    /* 
      Hacer que:
    ...
    */
    ...
    /*var setOfflineDevices = setInterval(() => {
      ...
      Subscribe: (observer) => Observer.subscribe(observer),
      Unsubscribe: (observer) => Observer.unsubscribe(observer),
      getDevices: (callback) => {
